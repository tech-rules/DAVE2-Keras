...
The simulator has two  different tracks. Track 1 was used for training and validation. The purpose of Track 2 is to make sure that the sokution is generalized and not overfitted to Track 1. (insert images side by side)
